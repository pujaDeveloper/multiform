...
export default class ThemeButton extends Component {
    render() {
        ...
        return (
            <TouchableOpacity disabled={disabled}  onPress={() => onClick()} style={[style, { backgroundColor:  isSubmitted ? Color.Green :  disabled ? 'grey' : Color.themeColor, width: screenWidth * 0.7, alignSelf: 'center', 
